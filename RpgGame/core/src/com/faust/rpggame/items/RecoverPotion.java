...
public class RecoverPotion extends Item {
	...
	public void useItem() {
		...
		case ItemFactory.ITEM_SMALLHEALTH:{
				result = CommonUtils.diceRoll(1, 8, 1, false);
				break;
			}		
		case ItemFactory.ITEM_MEDIUMHEALTH:{
				result = CommonUtils.diceRoll(2, 8, 2, false);
				break;
			}	
		case ItemFactory.ITEM_BIGHEALTH:{
				result = CommonUtils.diceRoll(4, 8, 4, false);
				break;
			}
		case ItemFactory.ITEM_SMALLENERGY:{
			result = CommonUtils.diceRoll(1, 4, 1, false);
			break;
			}		
		case ItemFactory.ITEM_MEDIUMENERGY:{
				result = CommonUtils.diceRoll(2, 4, 2, false);
				break;
			}	
		case ItemFactory.ITEM_BIGENERGY:{
				result = CommonUtils.diceRoll(4, 4, 4, false);
				break;
			}
		}
